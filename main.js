"use strict";
{
    ...
    let nft_extra = {
        tokenID: 18552,
        name: 'Why are colors so pretty',
        transfers: [],
        positions: [],
        last_value:2.5,
        createdAt : new Date('Jan-22-2021 09:11:41 PM').getTime(),
        createdBy : creatorAddress,
        last_owner: creatorAddress,
    }
    nft_extra.transfers.push({
        from: creatorAddress,
        to: '0xa9ccc49a14b707b9ec062ad83983c41ffc2a2e4e',
        time: new Date('Feb-16-2021 02:50:08 PM').getTime(),
        value: 2.5,
    });
    nft_extra.last_owner = '0xa9ccc49a14b707b9ec062ad83983c41ffc2a2e4e';
    collectors.set('0xa9ccc49a14b707b9ec062ad83983c41ffc2a2e4e', {name: "jonathan"});
    ...
    let nft_extra2 = {
        ...
        positions: [],
        last_value: 2,
        createdAt : new Date('Jan-17-2021 09:23:04 PM').getTime(),
        createdBy : creatorAddress,
        last_owner: creatorAddress,
    }
    nft_extra2.transfers.push({
        from: creatorAddress,
        to: '0x13f46ed75b388d748ab35134ca62abe36beb157f',
        time: new Date('Mar-03-2021 06:58:02 AM').getTime(),
        value: 2,
    });

    nft_extra2.last_owner = '0x13f46ed75b388d748ab35134ca62abe36beb157f';
    collectors.set('0x13f46ed75b388d748ab35134ca62abe36beb157f', {name: "chintan"});
    ...
    function draw(ts) {
        ...
        for (let key of nfts.keys()) {
            ...
            for(let i=0;i<nft.transfers.length;++i){
                ...
                let nextPos_y = h*0.1+fh*h*0.85;
                let nextSize = w*0.005*nft.transfers[i].value;
                //draw bezier 
                ...
                style = 'rgba(255,200,200,'+fs*global_end+')';
                //if(selected) {
                ...
                style = 'rgba(255,200,200,'+fs*global_end+')';
                if(selected) {
                    style = 'rgba(255,215,210,'+global_end*1.0+')';
                }
        ...
        ctx.textAlign = 'left';
        ctx.textBaseline = 'middle';
        ctx.fillText('ARC ON SUPERRARE',w*0.06, h*0.82);
        ctx.fillText('100 NFTS',w*0.06, h*0.845);
        ctx.fillText('68 COLLECTORS',w*0.06, h*0.86);
        ctx.fillText('FROM FEB.12 2020',w*0.06, h*0.875);
    ...
    function save_frame(ctx, n) {
        ...
        xhr.open('POST', `http://0.0.0.0:8080/save?desc=arc&frame=${n}`);
        xhr.send(data);
    }
